        ...
        <div class="min-w-full border-b border-gray-200 shadow">
            <table class="table-fixed w-full text-sm">
                <tbody class="bg-white">
                    ...
                    <tr>
                        <td class="border-b border-slate-100 p-4 pl-8 text-slate-500">{{ __('Position Unit') }}</td>
                        <td class="border-b border-slate-100 p-4 text-slate-500">{{$computer->bool_position ? $computer->containers->shelves->unities->code : $computer->shelves->unities->code}}</td>
                    </tr>
                    <tr>
                        <td class="border-b border-slate-100 p-4 pl-8 text-slate-500">{{ __('Position Unit') }}</td>
                        <td class="border-b border-slate-100 p-4 text-slate-500">{{$computer->bool_position ? $computer->containers->shelves->unities->zones->denomination : $computer->shelves->unities->zones->denomination}}</td>
                    </tr>
                    <tr>
